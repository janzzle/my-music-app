        ...
        <>
          ...
          <div className="absolute top-12 right-4 md:right-6 z-50 bg-white rounded-xl shadow-2xl border border-gray-100 w-56 overflow-hidden animate-fade-in-down origin-top-right">
            ...
            <nav className="flex flex-col">
              ...
              <button onClick={() => navigateTo('audience')} className="text-left px-4 py-3 hover:bg-gray-50 text-gray-700 border-b border-gray-100 text-sm">🎭 객석이동</button>
              <button onClick={() => navigateTo('history')} className="text-left px-4 py-3 hover:bg-gray-50 text-gray-700 border-b border-gray-100 text-sm">📅 누적순위</button>
              <button onClick={() => navigateTo('challenge')} className="text-left px-4 py-3 hover:bg-gray-50 text-gray-700 text-sm border-b border-gray-100">✨ 선곡신청</button>
